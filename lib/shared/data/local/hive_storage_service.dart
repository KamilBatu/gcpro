// For flexible type inference in Hive, we need to ignore some lints
...
class HiveHandler {
  ...
  Future<dynamic> getHistoryRequest(String id) => historyLazyBox.get(id);
  ...
  Future<void> removeUnused() async {
    ...
    if (environmentIds != null) {
      ...
      for (final key in environmentBox.keys.toList()) {
